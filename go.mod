...
require (
	...
	github.com/circlefin/noble-cctp/api v0.0.0-00010101000000-000000000000
...
replace (
	// use local version of circlefin/noble-cctp/api
	github.com/circlefin/noble-cctp/api => ./api
